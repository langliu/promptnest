...
function ChartTooltip({ active, payload, label }: ChartTooltipProps) {
  ...
  return (
    <div className='border-border bg-popover rounded-lg border px-3 py-2 text-xs shadow-md'>
      ...
      <p className='text-popover-foreground font-medium'>{payload[0].value}</p>
    </div>
  )
}
    ...
    <div className='grid gap-6 xl:grid-cols-2'>
      <section className='border-border bg-card rounded-xl border p-5'>
        <div className='mb-4'>
          ...
          <p className='text-muted-foreground mt-1 text-sm'>每日新建的 Prompt 数量</p>
        </div>
        <div className='h-72'>
      ...
      <section className='border-border bg-card rounded-xl border p-5'>
        <div className='mb-4'>
          ...
          <p className='text-muted-foreground mt-1 text-sm'>各模型下的 Prompt 数量</p>
        </div>
        <div className='h-72'>
      ...
      <section className='border-border bg-card rounded-xl border p-5 xl:col-span-2'>
        <div className='mb-4'>
          <h2 className='text-base font-semibold'>热门标签</h2>
          <p className='text-muted-foreground mt-1 text-sm'>使用频率最高的标签 Top 8</p>
        </div>
        <div className='h-64'>
